...
from dataset import HCPRestingFCDataset  # <-- your dataset loader
from timegan_model import TimeGAN        # <-- your TimeGAN implementation
...
def evaluate_subject_level_dedup_timegan(model, loader, device, pred_len: int):
    """
...
def main():
    ...
    test_metrics = evaluate_subject_level_dedup_timegan(
        model, test_loader, args.device, args.prediction_length
    )
