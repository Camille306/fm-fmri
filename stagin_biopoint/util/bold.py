...
def process_dynamic_fc(
    minibatch_timeseries, window_size, window_stride, dynamic_length=None, sampling_init=None, self_loop=True
):
    # input shape [minibatch x time x node]
    ...
    minibatch_fc_list = [
        get_minibatch_fc(minibatch_timeseries, p, window_size, self_loop) for p in sampling_points
    ]
